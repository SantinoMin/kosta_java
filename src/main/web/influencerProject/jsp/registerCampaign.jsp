...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>../css/registerCampaign.css">
...
<div class="bodyBackground">
    ...
    <form action="/submit" method="post" enctype="multipart/form-data">
        ...
        <div class="categoryContainer">
            ...
            <div class="first3">
                <div class="category">
                    <input type="radio" id="beauty" name="category" value="beauty" class="radio-input">
                    <label for="beauty" class="radio-label">
                        <img src="../logo/beauty.png" alt="뷰티" class="radio-image">
                    </label>
                </div>
                <div class="category">
                    <input type="radio" id="fashion" name="category" value="fashion" class="radio-input">
                    <label for="fashion" class="radio-label">
                        <img src="../logo/fashion.png" alt="패션" class="radio-image">
                    </label>
                </div>
                <div class="category">
                    <input type="radio" id="sport" name="category" value="sport" class="radio-input">
            ...
            <div class="second3">
                <div class="category">
                    <input type="radio" id="travel" name="category" value="travel" class="radio-input">
        ...
        <div class="requirement">
            ...
            <label>
                <textarea class="requirement-field" name="requirement" placeholder="여기에 요구 사항을 작성하세요..."></textarea>
            </label>
        </div>
